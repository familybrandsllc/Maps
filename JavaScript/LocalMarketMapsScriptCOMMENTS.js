	...
	mcOptions = { maxZoom: 9, styles: 
  	[
        ...
        //this is where it pulls the image URL used for this marker
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/LM-m1.png",
      ...
      //this is the second smallest cluster marker, usually yellow by default
			{
				height: 48,
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/LM-m2.png",
				width: 48,
				anchorText: [12, 0],
        textSize: 22,
        textColor: "#ffffff",
      ...
      //this is the mid sized cluster marker, usually red by default
			{
				height: 56,
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/LM-m3.png",
				width: 56,
				anchorText: [16, 0],
        textSize: 20,
        textColor: "#ffffff",
      ...
      //this is the second cluster marker, usually pink by default
			{
				height: 80,
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/LM-m4.png",
				width: 80,
				anchorText: [28, 0],
        textSize: 22,
        textColor: "#ffffff",
        fontWeight: "bold",
			...
			{
				height: 90,
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/LM-m5.png",
				width: 90,
				anchorText: [34, 0],
        textSize: 22,
        textColor: "#ffffff",
