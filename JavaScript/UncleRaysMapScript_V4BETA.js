...
const image 			="https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/UncleRaysPin3.png";
//this is used for the map styles
const gMapID = '647f4ba7a3a844f9';
...
{
	//set the style options for the cluster markers
	mcOptions = { maxZoom: 9, styles: 
  	[
    	//this is the smallest cluster marker, usually blue by default
  		{
      	//this sets the height of the marker, should be the same as width
				height: 40,
        //this is where it pulls the image URL used for this marker
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/URClusters_1.png",
        //this sets the width of the marker, should be the same as the height
				width: 40,
        //this sets the position of the text on the marker
				anchorText: [8, 0],
        textSize: 22,
        textColor: "#ffffff",
        fontWeight: "bold",
      ...
      //this is the second smallest cluster marker, usually yellow by default
			{
				height: 48,
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/URClusters_2.png",
				width: 48,
				anchorText: [12, 0],
        textSize: 22,
        textColor: "#ffffff",
      ...
      //this is the mid sized cluster marker, usually red by default
			{
				height: 56,
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/URClusters_3.png",
				width: 56,
				anchorText: [16, 0],
        textSize: 20,
        textColor: "#ffffff",
      ...
      //this is the second cluster marker, usually pink by default
			{
				height: 80,
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/URClusters_4.png",
				width: 80,
				anchorText: [28, 0],
        textSize: 22,
        textColor: "#ffffff",
        fontWeight: "bold",
			...
			{
				height: 90,
				url: "https://cdn.jsdelivr.net/gh/familybrandsllc/Maps@main/Markers/URClusters_5.png",
				width: 90,
				anchorText: [34, 0],
        textSize: 22,
        textColor: "#ffffff",
...
//initialize the clusterer with your options using the marker options set above
var mc = new MarkerClusterer(map, markers, mcOptions);
  //clus variable defined at top of page
  //this is to make the following loop run every time after 
  if (clus == 1 )
  {
  	//clear marers function to make sure the cluster doesnt redraw itself
  	mc.clearMarkers();
	}
  //to make sure that the above loop is always run after first run
  clus = 1;
}
//
//
...
function clearCluster()
{
	//set clus value to 1
  clus = 1;
  //run the cluster stores function
  clusterStores();
...
function displayStores(stores)
{
    ...
    for(var [index, store] of stores.entries())
    {
        ...
        var divLink = "https://www.google.com/maps/search/"+Address.replaceAll(' ', '+');
        ...
        <div class="store-block">
    			...
    			<a href="${divLink}" target="_blank" class="store-directions w-button">DIRECTIONS</a>
				</div>     
    `
...
function showStoresMarkers(stores)
{
    ...
    for(var [index, store] of stores.entries())
    {
        ...
        createMarker(latlng, name, zip, Address)
    }
...
function createMarker(latlng, name, zip, Address)
	{
  	//this variable is t create an HREF link for the infoWindow
  	var link = "https://www.google.com/maps/search/"+Address.replaceAll(' ', '+');
